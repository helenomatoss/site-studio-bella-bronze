...
const Contact = () => {
  ...
  return (
    <section id="contato" className="relative py-20 md:py-24 px-4 sm:px-6 bg-light overflow-hidden">
      {/* Soft Glow */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="max-w-5xl mx-auto px-2 sm:px-4">
          <div className="glass-card rounded-3xl p-8 sm:p-10 md:p-12 text-center">
            <p className="text-xl md:text-2xl text-dark/80 mb-10 md:mb-12 font-light">
